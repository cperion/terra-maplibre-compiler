...
-- Add one fixture-driven test that parses `shared/fixtures/specs/minimal-clear.json` and `shared/fixtures/specs/fill-layer.json` via parser module and asserts validator accepts both. AI!-- Unit tests for spec validator
